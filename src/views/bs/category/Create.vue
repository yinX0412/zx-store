<template>
    <div v-loading="loading">
        ...
        <el-button type="primary" size="small" @click="createCategory">创建</el-button>
        <el-dialog
            title="分类属性"
            @close="closeDialog"
...
<script lang="ts">
    ...
    import {AttributeList, createCategory, CreateCategoryArgs, getAttrList} from '@/service/bs/bs-category-service';
    ...
    export default class BsCreateCategory extends Vue {
        ...
        private form: CreateCategoryArgs = {
            category_name: '',
            image: '',
            attribute_id: [],
        };
